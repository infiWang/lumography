...
impl Color
{
    ...
    #[inline]
    pub fn rgbEmpty() -> Color
    {
        Color::new( 0.0, 0.0, 0.0 )
    }
    #[inline]
    pub fn rgbFull() -> Color
    {
...
impl RGB8
{
    ...
    pub fn gammaCorrection(&self) -> RGB8 { RGB8::new(RGB8::GAMMA_TABLE[(self.r as usize)], RGB8::GAMMA_TABLE[(self.g as usize)], RGB8::GAMMA_TABLE[(self.b as usize)]) }
